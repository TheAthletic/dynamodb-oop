...
Batch.prototype.count = function () {
  ...
  return this.payload.RequestItems[this.current_table].length;
};
...
Batch.prototype.put = function (item) {
  ...
  if (!this.current_table) {
    this.err = {
      code: "INVALID_TABLE",
      message: "use .table( tbl_name ) before .put()",
    };
    return this;
  }
  ...
  if (typeof item !== "object") {
    this.err = {
      code: "INVALID_ITEM",
      message: ".put( item ) - must pass in an Object",
    };
    return this;
  }
...
Batch.prototype.delete = function (item) {
  ...
  if (!this.current_table) {
    this.err = {
      code: "INVALID_TABLE",
      message: "use .table( tbl_name ) before .delete()",
    };
    return this;
  }
  ...
  if (typeof item !== "object") {
    this.err = {
      code: "INVALID_ITEM",
      message: ".del( item ) must pass in an Object",
    };
    return this;
  }
...
Batch.prototype.get = function (item) {
  ...
  if (!this.current_table) {
    this.err = {
      code: "INVALID_TABLE",
      message: "use .table( tbl_name ) before .get()",
    };
    return this;
  }
  ...
  if (typeof item !== "object") {
    this.err = {
      code: "INVALID_ITEM",
      message: ".get( item ) - must pass in an Object",
    };
    return this;
  }
  ...
  this.payload.RequestItems[this.current_table].Keys.push(
    util.stringify(item).M
  );
...
Batch.prototype.consistent_read = function ($value) {
  ...
  if (!this.current_table) {
    this.err = {
      code: "INVALID_TABLE",
      message: "use .table( tbl_name ) before .consistent_read()",
    };
    return this;
  }
...
Batch.prototype.read = function (cb) {
  ...
  this.routeCall("batchGetItem", $thisQuery, true, function (err, data) {
    ...
    Object.keys(data.Responses).map(function (tbl_name) {
      ...
      ret[tbl_name] = util.parse({
        L: (data.Responses[tbl_name] || []).map(function (item) {
          return { M: item };
        }),
      });
    });
