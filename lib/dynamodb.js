...
function createDynamoOopClient(dynamoDbClient) {
  return new DynamoDB(dynamoDbClient);
};

var DynamodbFactory = createDynamoOopClient;
DynamodbFactory.util = require("@awspilot/dynamodb-util");
DynamodbFactory.util.cleanItem = (data) =>
  Object.entries(data)
  ...
  if (typeof callback !== "function") {
    return new Promise(function (fullfill, reject) {
      $this.describeTable($this.tableName, function (err, data) {
        ...
        var $thisQuery = {
          TableName: $this.tableName,
          Item: DynamodbFactory.util.cleanItem(
            DynamodbFactory.util.anormalizeItem(item)
          ),
...
module.exports.createDynamoOopClient = createDynamoOopClient;
module.exports.DynamoOopClient = DynamoDB;
module.exports.Request = Request;

/** @deprecated - use DynamoOopClient instead */
